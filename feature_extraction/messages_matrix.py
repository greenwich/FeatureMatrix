...
class MessagesMatrixBuilder(object):
    """
    ...
    def get_matrix(self):
        ...
        return numpy.matrix([[(word in w and w[word] or 0) for word in vector] for w in self._message_words]), vector
